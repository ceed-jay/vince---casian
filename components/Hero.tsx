...
export const Hero: React.FC<HeroProps> = ({ bgImageUrl }) => {
  return (
    <section id="home" className="relative h-[100svh] flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-white">
      ...
      >
        <h1 className="font-symphony text-7xl sm:text-8xl md:text-9xl lg:text-[12rem] text-white tracking-normal drop-shadow-2xl leading-[0.8] sm:leading-none sm:whitespace-nowrap">
      ...
      {/* Quote - Centered between names and scroll indicator */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 1.5, duration: 1.2, ease: "easeOut" }}
        className="absolute bottom-44 text-center z-10 px-6 w-full"
      >
